...
class ProfileAttributes(admin.ModelAdmin):
    list_display = ('id','user', 'name', 'address', 'lat', 'lng', 'phone_number','date_of_birth', 'is_seller', 'is_buyer', 'is_driver')
...
class ShopsAttributes(admin.ModelAdmin):
    list_display = ('id','seller', 'shop_name', 'shop_address', 'open_time', 'close_time', 'is_always_open', 'lat', 'lng')
